...
OUT = ROOT / "docs" / "assets" / "article" / "pacific_delay_overview_clean_v27.png"
DESKTOP_OUT = Path(r"C:\Users\zhen.luo\Desktop\article\overview_clean_v27.png")
...
def main() -> None:
    ...
    draw = ImageDraw.Draw(canvas)
    draw.rectangle((360, 55, 1450, 225), fill="white")
