...
def main() -> None:
    ...
    arch = [
        ...
        to_Conv(
            "spatial6", s_filer="4050", n_filer="256", offset="(4.20,0,0)", to="(spatial1-east)",
        ...
        r"\coordinate (spatial-gap-l) at ($(spatial1-east)!0.30!(spatial6-west)$);",
        r"\coordinate (spatial-gap-r) at ($(spatial1-east)!0.70!(spatial6-west)$);",
        ...
        r"\node[font=\Huge\bfseries,text=black!65] at (spatial-gap) {$\cdots$};",
