...
def plot_surface(ax, lon: np.ndarray, lat: np.ndarray, field: np.ndarray, corners, cmap, norm, title: str):
    ...
    ax.text(0.5, 0.95, title, ha="center", va="top", fontsize=12, fontweight="bold")
