...
OUT = ROOT / "docs" / "assets" / "article" / "pacific_delay_overview_rebuilt_v25.png"
DESKTOP_OUT = Path(r"C:\Users\zhen.luo\Desktop\article\overview_rebuilt_v25.png")
...
def main() -> None:
    ...
    canvas.paste(Image.fromarray(base[:, :580]), (0, 0))
    canvas.paste(Image.fromarray(base[:230, 580:]), (580, 0))
    ...
    draw = ImageDraw.Draw(canvas)
    draw.rectangle((580, 55, 1450, 225), fill="white")
