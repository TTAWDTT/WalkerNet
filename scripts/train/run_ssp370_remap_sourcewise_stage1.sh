...
CONFIG="${ROOT_DIR}/configs/server_3090_ssp370_sourcewise_stage1.yaml"
RAW_ROOT="${ROOT_DIR}/cmip6-ssp"
REMAP_ROOT="${ROOT_DIR}/cmip6_ssp_1x1"
CHECKPOINT_DIR="${ROOT_DIR}/checkpoints_ssp370_sourcewise_stage1"
RUNTIME_DIR="${ROOT_DIR}/runtime/ssp370_sourcewise_stage1"
LOG_DIR="${ROOT_DIR}/outputs/logs"
PIPELINE_LOG="${LOG_DIR}/ssp370_sourcewise_pipeline.log"
TRAIN_LOG="${LOG_DIR}/ssp370_sourcewise_stage1.log"
